...
|client_name                        |string       |beaconnode, validator|hard-coded to "sila"                                                    |Name of the client type. Ex: sila, lighthouse, nimbus, teku                                                                                                            |
|client_version                     |string       |beaconnode, validator|prom: sila_version (label: version)                                     |Client version. Ex: 1.0.0-beta.0                                                                                                                                        |
|client_build                       |int          |beaconnode, validator|prom: sila_version (label: buildDate)                                   |Integer representation of build for easier comparison                                                                                                                   |
...
|sync_sila1_connected                |bool         |beaconchain          |prom: powchain_sync_sila1_connected                                       |Whether or not the beacon chain node is connected to a _synced_ sila1 node                                                                                               |
...
|sync_sila1_fallback_configured      |bool         |beaconchain          |prom: powchain_sync_sila1_fallback_configured                             |Whether or not the beacon chain node has a fallback sila1 endpoint configured.                                                                                           |
|sync_sila1_fallback_connected       |bool         |beaconchain          |prom: powchain_sync_sila1_fallback_connected                              |Whether or not the beacon chain node is connected to a fallback sila1 endpoint. A true value indicates a failed or interrupted connection with the primary sila1 endpoint.|
