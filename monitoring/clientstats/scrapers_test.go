...
func TestBeaconNodeScraper(t *testing.T) {
	...
	require.Equal(t, "sila", bs.ClientName)
...
func TestValidatorScraper(t *testing.T) {
	...
	require.Equal(t, "sila", vs.ClientName)
...
func TestBadInput(t *testing.T) {
	...
	require.NoError(t, err)
	require.LogsContain(t, hook, "Failed to get sila_version")
}
...
# HELP sila_version
# TYPE sila_version gauge
sila_version{buildDate="1619586241",commit="51eb1540fa838cdbe467bbeb0e36ee667d449377",version="v1.3.8-hotfix+6c0942"} 1
