...
type CommonStats struct {
	...
	SyncSilaConsensusFallbackConfigured bool `json:"sync_sila_fallback_configured"`
	...
	SyncSilaConsensusFallbackConnected bool `json:"sync_sila_fallback_connected"`
...
type BeaconNodeStats struct {
	...
	SyncSilaExecutionConnected         bool  `json:"sync_silaexec_connected"`
	SyncSilaConsensusSynced            bool  `json:"sync_sila_synced"`
