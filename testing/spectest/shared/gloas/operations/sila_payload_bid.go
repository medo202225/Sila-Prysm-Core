...
func blockWithSignedSilaPayloadBid(blockSSZ []byte) (interfaces.SignedBeaconBlock, error) {
...
func RunSilaPayloadBidTest(t *testing.T, config string) {
	common.RunSilaPayloadBidTest(t, config, version.String(version.Gloas), blockWithSignedSilaPayloadBid, sszToState)
}
