...
Since [PR 15312](https://github.com/sila-chain/Sila-Prysm-Core), Sila-Prysm has support to download "nightly" spectests from github via a starlark rule configuration by environment variable.
