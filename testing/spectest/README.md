...
Spec testing vectors: https://github.com/sila/consensus-spec-tests
...
Since [PR 15312](https://github.com/sila-chain/Sila-Core), Sila has support to download "nightly" spectests from github via a starlark rule configuration by environment variable.
