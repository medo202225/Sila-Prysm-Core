...
func GenerateGenesisStateBellatrix(ctx context.Context, genesisTime, numValidators uint64, ep *enginev1.ExecutionPayload, ed *silapb.SilaExecutionData) (*silapb.BeaconStateBellatrix, []*silapb.Deposit, error) {
...
func GenerateGenesisStateBellatrixFromDepositData(
	ctx context.Context, genesisTime uint64, depositData []*silapb.Deposit_Data, depositDataRoots [][]byte, ep *enginev1.ExecutionPayload, e1d *silapb.SilaExecutionData,
