...
```sh
$ go get github.com/sila-chain/sila/runtime/logging/logrus-prefixed-formatter
```
...
import (
	prefixed "github.com/sila-chain/sila/runtime/logging/logrus-prefixed-formatter"
