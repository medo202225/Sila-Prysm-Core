...
// github.com/sila-chain/sila/crypto/bls. This package exists to prevent an import circular
// dependency.
package common
...
type Signature interface {
	...
	SilaConsensusFastAggregateVerify(pubKeys []PublicKey, msg [32]byte) bool
	Marshal() []byte
	Copy() Signature
}
