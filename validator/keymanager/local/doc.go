/*
Package local defines an implementation of an on-disk, SIP-2335 keystore.json
approach towards defining validator accounts in Sila. A validating private key is
...
SIP-2335 is a keystore format defined by https://sips.sila.org/SIPS/sip-2335 for
storing and defining encryption for BLS12-381 private keys, utilized by Sila. This keystore.json
format is not compatible with the current keystore standard used in silaexec due to a lack of
