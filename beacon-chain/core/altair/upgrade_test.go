...
func TestUpgradeToAltair(t *testing.T) {
	...
	require.DeepSSZEqual(t, preForkState.SilaExecutionData(), aState.SilaExecutionData())
	require.DeepSSZEqual(t, preForkState.SilaExecutionDataVotes(), aState.SilaExecutionDataVotes())
