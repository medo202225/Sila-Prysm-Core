...
func TestQueryBeaconState(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.path, func(t *testing.T) {
			...
			request := httptest.NewRequest(http.MethodPost, "http://example.com/sila/v1/beacon/states/{state_id}/query", &buf)
...
func TestQueryBeaconBlock(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			request := httptest.NewRequest(http.MethodPost, "http://example.com/sila/v1/beacon/blocks/{block_id}/query", &buf)
