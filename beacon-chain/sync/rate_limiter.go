...
func newRateLimiter(p2pProvider p2p.P2P) *limiter {
	...
	topicMap[addEncoding(p2p.RPCSilaPayloadEnvelopesByRootTopicV1)] = envelopeCollector
	topicMap[addEncoding(p2p.RPCSilaPayloadEnvelopesByRangeTopicV1)] = envelopeCollector
