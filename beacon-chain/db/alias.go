...
// HeadAccessDatabase exposes Sila-Prysm's Sila backend for read/write access with information about
...
// SlasherDatabase defines necessary methods for Sila-Prysm's slasher implementation.
