...
// SilaPayloadBidGossipRequirements defines the list of requirements for gossip sila payload bids.
...
// GossipSilaPayloadBidRequirements is a requirement list for gossip sila payload bids.
var GossipSilaPayloadBidRequirements = requirementList(SilaPayloadBidGossipRequirements)
...
var _ SilaPayloadBidVerifier = &BidVerifier{}

// BidVerifier is a read-only verifier for sila payload bids.
type BidVerifier struct {
	*sharedResources
	results *results
	b       interfaces.ROSignedSilaPayloadBid
}
