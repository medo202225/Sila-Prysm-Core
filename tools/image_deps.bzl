...
def sila_image_deps():
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/bash_5.1-2+deb11u1_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/bash_5.1-2+deb11u1_arm64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libtinfo6_6.2+20201114-2+deb11u2_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libtinfo6_6.2+20201114-2+deb11u2_arm64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/coreutils_8.32-4+b1_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/coreutils_8.32-4_arm64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libselinux1_3.1-3_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libselinux1_3.1-3_arm64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libpcre2-8-0_10.36-2+deb11u1_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libpcre2-8-0_10.36-2+deb11u1_arm64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libattr1_2.4.48-6_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libattr1_2.4.48-6_arm64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libacl1_2.2.53-10_amd64.deb",
        ],
    )
    ...
    debian_archive(
        ...
        urls = [
            ...
            "https://sila.com/uploads/libacl1_2.2.53-10_arm64.deb",
        ],
    )
