...
signing and withdrawal keys. These keys can be fed into the Sila validator
client for fast development startup times instead of using the Sila keystore.
...
The file can then be used to start the Sila validator with the command:
