// Package main provides a tool named split-keys which allows for generating any number of Sila validator keys
// from a list of BIP39 mnemonics and spreading them across any number of Sila wallets. This is useful for creating
